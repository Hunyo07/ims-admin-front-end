  ...
  return [
    {
      ...
      title: 'Total Revenue',
      total: `₱${dashboardData.value.salesStats?.overview?.totalRevenue?.toLocaleString() || '0'}`,
      growthRate: 0.43
    },
    {
      icon: `<svg class="fill-primary dark:fill-white" width="20" height="22" viewBox="0 0 20 22" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      title: 'Total Sales',
      total: dashboardData.value.salesStats?.overview?.totalSales?.toString() || '0',
      growthRate: 4.35
    },
    {
      icon: `<svg class="fill-primary dark:fill-white" width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      title: 'Total Products',
      total: dashboardData.value.productStats?.totalProducts?.toString() || '0',
      growthRate: 2.59
    },
    {
      icon: `<svg class="fill-primary dark:fill-white" width="22" height="18" viewBox="0 0 22 18" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      title: 'Active Users',
      total: dashboardData.value.userStats?.activeUsers?.toString() || '0',
      growthRate: 1.25
    }
  ]
})
          ...
          <div v-else class="space-y-3">
            ...
            >
              ...
              <div class="text-right">
                ...
                <p class="text-xs text-gray-500">{{ sale.items?.length || 0 }} items</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="rounded-sm border border-stroke bg-white px-5 pt-6 pb-2.5 shadow-default dark:border-strokedark dark:bg-boxdark sm:px-7.5 xl:pb-1">
          ...
          <div v-else class="space-y-3">
            ...
            >
              ...
              <div class="text-right">
                <p class="font-semibold text-danger">{{ product.currentStock }}</p>
